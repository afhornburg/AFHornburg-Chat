...
import 'package:flutter_chat_demo/Frontend/Conversas.dart';
import 'package:flutter_chat_demo/Frontend/Constantes.dart';
import 'package:flutter_chat_demo/Frontend/login.dart';
import 'package:flutter_chat_demo/Frontend/Configuracoes.dart';
...
class MainScreenState extends State<MainScreen> {
  ...
  void registerNotification() {
    ...
    firebaseMessaging.configure(onMessage: (Map<String, dynamic> message) {
      ...
      showNotification(message['Notificação']);
      return;
